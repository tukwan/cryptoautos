    ...
    <div className="process-container">
      <div className="process-step">
        ...
        <p className="step-description">
          Find your dream car. Explore the vast selection of over 20,000 cars on
          our listings page.
        </p>
      </div>
      <div className="process-step">
        ...
        <p className="step-description">
          Contact us via email, WhatsApp, or on the phone and have a CryptoAutos
          representative run you through the buying process and arranging a test
          drive. Once you’re happy, you can reserve your vehicle.
        </p>
      </div>
